...
export default function Conversation() {
    ...
    function Handler(item: object) {
        navigation.navigate("Chat", { params: { item: item } })
    ...
    return <Box>
        ...
        <FlatList data={data} renderItem={({
            item
                ...
                <Box my={3} borderBottomWidth="0" _dark={{
                    borderColor: "muted.50"
                }} borderColor="muted.800" pl={["0", "4"]} pr={["0", "5"]} py="2">
                    <HStack space={[2, 3]} justifyContent="space-between" mx={10}>
